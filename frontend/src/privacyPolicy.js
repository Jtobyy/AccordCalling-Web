...
export class PrivacyPolicy extends React.Component {    
    render() {
        return (
            <Box px={5}>
                <Header />
                <Typography variant='h5' mt={20}>PRIVACY POLICY</Typography>
            
                <Typography pb={4}>Date: 01 January, 2023</Typography>
                <Box>
                    <Typography py={2}>1. Introduction</Typography>
                    Welcome to Tech4mation Limited.
                    Tech4mation Limited (“us”, “we”, or “our”) operates <a href="https://accordcalling.com/">AccordCalling</a> (hereinafter referred to as “Service”).
                    Our Privacy Policy governs your visit to <a href="https://accordcalling.com/">AccordCalling</a> and explains how we collect, safeguard and disclose information that results from your use of our Service.
                    We use your data to provide and improve Service. By using our Service, you agree to the collection and use of information under this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions.
                ...
                <Box>
                    ...
                    SERVICE means the <a href="https://accordcalling.com/">AccordCalling</a> application and website operated by Tech4mation Limited.
                    PERSONAL DATA means data about a living inBoxidual who can be identified from that data (or from other information either in our possession or likely to come into our possession).
                    ...
                    DATA SUBJECT is any living inBoxidual who is the subject of Personal Data.
                    THE USER is the inBoxidual using our Service. The User corresponds to the Data Subject, who is the subject of Personal Data.
                </Box>
                <Box>
                    <Typography py={2}>3. Information Collection and Use</Typography>
                    We collect several different types of information for various purposes to provide and improve our Service to you.
                </Box>
                <Box>
                <Typography py={2}>4. Types of Data Collected</Typography>
                    Personal Data
                    ...
                    0.3. Phone number
                    0.4. Address, City, State, Country, ZIP/Postal code
                ...
                <Box>
                <Typography py={2}>5.Use of Data</Typography>
                    Tech4mation Limited uses the collected data for various purposes:
                ...
                <Box>
                <Typography py={2}>6. Retention of Data</Typography>
                ...
                <Box>
                <Typography py={2}>7. Transfer of Data</Typography>
                ...
                <Box>
                <Typography py={2}>9. Security of Data</Typography>
                    The security of your data is important to us but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.
                </Box>
                <Box>
                <Typography py={2}>10. Your Data Protection Rights Under General Data Protection Regulation (GDPR)</Typography>
                    If you are a resident of the European Union (EU) and European Economic Area (EEA), you have certain data protection rights, covered by GDPR.
                    We aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.
                    If you wish to be informed of what Personal Data we hold about you and if you want it to be removed from our systems, please email us at support@accordcalling.com.
                ...
                <Box>
                <Typography py={2}>11. Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</Typography>
                    CalOPPA is the first state law in the nation to require commercial websites and online services to post a privacy policy. The law’s reach stretches well beyond California to require a person or company in the United States (and conceivable the world) that operates websites collecting personally identifiable information from California consumers to post a conspicuous privacy policy on its website stating exactly the information being collected and those inBoxiduals with whom it is being shared and to comply with this policy.
                    ...
                    0.4. users can change their personal information by emailing us at support@accordcalling.com.
                </Box>
                <Box>
                <Typography py={2}>12. Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</Typography>
                    ...
                    0.3. To stop selling your personal information. We don’t sell or rent your personal information to any third parties for any purpose. We do not sell your personal information for monetary consideration. However, under some circumstances, a transfer of personal information to a third party, or within our family of companies, without monetary consideration may be considered a “sale” under California law. You are the only owner of your Data and can request disclosure or deletion at any time.
                    If you submit a request to stop selling your personal information, we will stop making such transfers.
                    Please note, that if you ask us to delete or stop selling your data, it may impact your experience with us, and you may not be able to participate in certain programs or membership services which require the usage of your personal information to function. But in no circumstances, we will discriminate against you for exercising your rights.
                    To exercise your California data protection rights described above, please send your request(s) by email: support@accordcalling.com.
                    Your data protection rights, described above, are covered by the CCPA, short for the California Consumer Privacy Act. To find out more, visit the official California Legislative Information website. The CCPA took effect on 01/01/2020.
                </Box>
                <Box>
                <Typography py={2}>13. Service Providers</Typography>
                    We may employ third-party companies and inBoxiduals to facilitate our Service (“Service Providers”), provide Service on our behalf, perform Service-related services or assist us in analyzing how our Service is used.
                    These third parties have access to your Personal Data only to perform these tasks on our behalf and are obligated not to disclose or use it for any other purpose.
                </Box>
                <Box>
                <Typography py={2}>14. Analytics</Typography>
                    We may use third-party Service Providers to monitor and analyze the use of our Service.
                </Box>
                <Box>
                <Typography py={2}>15. CI/CD tools</Typography>
                    We may use third-party Service Providers to automate the development process of our Service.
                </Box>
                <Box>
                <Typography py={2}>16. Behavioral Remarketing</Typography>
                ...
                <Box>
                <Typography py={2}>17. Payments</Typography>
                ...
                <Box>
                <Typography py={2}>18. Links to Other Sites</Typography>
                    Our Service may contain links to other sites that are not operated by us. If you click a third-party link, you will be directed to that third party’s site. We strongly advise you to review the Privacy Policy of every site you visit.
                    We have no control over and assume no responsibility for the content, privacy policies or practices of any third-party sites or services.
                </Box>
                <Box>
                <Typography py={2}>19. Changes to This Privacy Policy</Typography>
                ...
                <Box>
                <Typography py={2}>20. Contact Us</Typography>
                    If you have any questions about this Privacy Policy, please contact us by email: <a href="mailto:support@accordcalling.com">support@accordcalling.com</a>
                </Box>
            </Box>
        )  
    }
